...
use crate::frames::{self, ExtractedFrames, FrameExtractConfig};
use crate::landmarks::LandmarkSequence;
use crate::segmentation::MaskSequence;
use crate::tracking::TrackingSequence;
...
pub fn preprocess(
    ...
    let count = crate::background::extract_foreground_frames(
        &frames_dir,
        &masks_dir,
        &face_dir,
        config.bg_color,
